/**
 * PhysicsConstants.ts - Constantes physiques pour la simulation
 *
 * Définit toutes les constantes physiques utilisées dans la simulation
 * du cerf-volant. Ces valeurs définissent les limites et comportements
 * physiques du monde virtuel.
 */
