/**
 * KiteGeometry.ts - Géométrie du cerf-volant
 *
 * Définit la forme et les points géométriques du cerf-volant.
 * Cette classe contient tous les points clés et surfaces du kite.
 */
